            ...
            <div class="col-12">
                <table class="table stripe" id="service-list-table">
                    ...
                    <tr>
                        ...
                        <th class="text_head_table">service</th>
                        <th></th>
                    </tr>
                    </thead>
                    <tbody>
            ...
            columns: [
                {
                    ...
                    render: function (_, _, row) {
                        return '<img style="width: 70px;height: 50px;" src="{!! url('/admin/client-list/image/') !!}/' + row.path_img_small + '">'
                    },
                },
                {data: 'name', name: 'name', orderable: true},
                {data: 'contents_name', name: 'contents_name', orderable: true},
                {
                    data: 'id',
                    name: 'id',
                    searchable: false,
                    orderable: false,
                    render: function (_, _, row) {
                        return '<a class=\'btn btn-primary\' href=\'' + ('{{route('admin.client.update',['client'=>':id'])}}').replace(':id', row.id) + '/edit' + '\'>แก้ไขข้อมูล</a>' +
        ...
        function Delete(id) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{!! route('admin.client-list.delete') !!}',
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
