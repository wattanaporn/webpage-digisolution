        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-primary"
                   href="{{route('admin.company-logo.create')}}"
                >
                    add logo
                </a>
            </div>
...
@push('js')
    ...
    <script>
        ...
        $('#service-list-table').DataTable({
            ...
            searchDelay: 450,
            ajax: {
                url: '{{route('admin.company-logo-list')}}',
            },
            language: {
            ...
            columns: [
                {
                    ...
                    render: function (_, _, row) {
                        return '<img style="width: 70px;height: 50px;" src="{!! url('/admin/company-logo-list/image/') !!}/' + row.path_img + '">'
                    },
                },
                {data: 'company_name', name: 'company_name', orderable: true},
                {
                    ...
                    orderable: false,
                    render: function (_, _, row) {
                        return '<a class=\'btn btn-primary\' href=\'' + ('{{route('admin.company-logo.update',['company_logo'=>':id'])}}').replace(':id', row.id) + '/edit' + '\'>แก้ไขข้อมูล</a>' +
